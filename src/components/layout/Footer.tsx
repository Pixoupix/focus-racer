        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {Object.values(footerLinks).map((section) => (
            <div key={section.title}>
              <h3 className="font-semibold text-sm uppercase tracking-wider text-orange-light mb-4">
                {section.title}
              </h3>
        ...
        <div className="border-t border-navy-light mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-navy-200 hover:text-orange transition-colors duration-200"
              aria-label="Twitter"
            >
